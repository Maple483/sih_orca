(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      #orca-satellite-fullscreen .sat-fs-gradient{height:14px;width:100%;display:block;border-radius:999px;border:1px solid rgba(255,255,255,.24);background-color:#0f172a!important;overflow:hidden}
      #orca-satellite-fullscreen .sat-fs-gradient.sst-gradient{background-image:linear-gradient(90deg,#2b001a 0%,#4b0030 14%,#65124d 28%,#3d47a5 42%,#087fd8 55%,#00bfae 68%,#8bd646 80%,#f5e942 91%,#ff8c24 100%)!important}
      #orca-satellite-fullscreen .sat-fs-gradient.chl-gradient{background-image:linear-gradient(90deg,#1b1464 0%,#185ac6 18%,#14b8a6 38%,#5ccf73 55%,#d8df42 72%,#f5a623 86%,#d7191c 100%)!important}
  ...
  function addFullscreenLegend(container, type) {
    ...
    if (type === 'sst') {
      legend.innerHTML = `
        ...
        <div class="sat-fs-gradient sst-gradient" style="background-image:linear-gradient(90deg,#2b001a 0%,#4b0030 14%,#65124d 28%,#3d47a5 42%,#087fd8 55%,#00bfae 68%,#8bd646 80%,#f5e942 91%,#ff8c24 100%) !important;"></div>
      ...
      legend.innerHTML = `
        ...
        <div class="sat-fs-gradient chl-gradient" style="background-image:linear-gradient(90deg,#1b1464 0%,#185ac6 18%,#14b8a6 38%,#5ccf73 55%,#d8df42 72%,#f5a623 86%,#d7191c 100%) !important;"></div>
